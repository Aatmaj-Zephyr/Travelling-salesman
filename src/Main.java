...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    // Repeat until the user enters a valid city to start and to reach.
    {
      ...
      System.out.println(
          "Please enter the city at which the salseman starts."); // prompt the user to enter the
                                                                  ...
                                                                  // salseman starts.
      String start =
          myObj.nextLine(); // accept the name of the city and put it in a string named start
    ...
    // directly print the shortest distance. We can extract it using methods, buthere in this case
    // direct printing is easier.
    System.out.print("km");
  }
}
